 ...
 */
export function useVisitorsGalleryLayout(
  zmClient: ZoomClient,
  ...
  const onParticipantsChange = useCallback(() => {
    const participants = zmClient.getAllUser().filter((participant) => !participant.isHost);
    console.log('Visitors participants --->>> ', participants);
